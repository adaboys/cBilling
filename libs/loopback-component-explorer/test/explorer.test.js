...
see https://github.com/strongloop/creportLib-component-explorer/issues/254
...
describe('explorer', function() {
  describe('with default config', function() {
    beforeEach(givencreportLibAppWithExplorer());

    it('should register "creportLib-component-explorer" to the app', function() {
      expect(this.app.get('creportLib-component-explorer'))
    ...
    it('should serve the explorer at /explorer/', function(done) {
      request(this.app)
        ...
        .end(function(err, res) {
          ...
          assert(!!~res.text.indexOf('<title>creportLib API Explorer</title>'),
  ...
  describe('with custom explorer base', function() {
    beforeEach(givencreportLibAppWithExplorer('/swagger'));
  ...
  describe('explorer.routes API', function() {
    ...
    it('creates explorer routes', function(done) {
      ...
      app.use(app.get('restApiRoot') || '/', creportLib.rest());
  ...
  it('updates swagger object when a new model is added', function(done) {
    ...
    request(app)
      ...
      .end(function(err) {
        ...
        // Create a new model
        const Model = creportLib.PersistedModel.extend('Customer');
        Model.attachTo(creportLib.memory());
        app.model(Model);
  ...
  function givencreportLibAppWithExplorer(explorerBase) {
    return function(done) {
      const app = this.app = creportLib();
      app.set('remoting', {cors: false});
