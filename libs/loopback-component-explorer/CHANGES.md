 ...
 * Increment creportLib-swagger ver (rashmihunt)
 ...
 * Change Explorer header to use creportLib (emckean)
 ...
 * bump creportLib-swagger version to 3.0.1 (Jurien Hamaker)
 ...
 * Update deps to creportLib 3.0.0 RC (Miroslav Bajtoš)

 * Deprecate built-in CORS middleware (Miroslav Bajtoš)

 * Use creportLib@3.0.0-alpha for running the tests. (Miroslav Bajtoš)
 ...
 * Upgrade creportLib devDependency (Supasate Choochaisri)
 ...
 * Rename the module to creportLib-component-explorer (Rand McKinney)
 ...
 * Use creportLib-swagger to generate swagger.json (Miroslav Bajtoš)

 * Bump up strong-swagger-ui version to ^21.0.0 (Miroslav Bajtoš)

 * Register creportLib-explorer to app (Hage Yaapa)
 ...
 * Rework the module to a creportLib component (Miroslav Bajtoš)
 ...
 * Move CSS customizations to creportLibStyles.css (Miroslav Bajtoš)
 ...
 * Removed branch-lock for creportLib (Shelby Sanders)
 ...
 * Reverted to use special loading logic from creportLib-explorer (Shelby Sanders)
 ...
 * creportLibStyles: improve spacing in small window (Miroslav Bajtoš)
 ...
 * Fix up creportLib.rest() model definition hack. (Samuel Reed)
 ...
 * package.json: add support for creportLib 2.x (Miroslav Bajtoš)
 ...
 * Bump up creportLib min version to 1.5 (Miroslav Bajtoš)
 ...
 * Fix loading of creportLib dependencies. (Miroslav Bajtos)
