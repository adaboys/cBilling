...
Thank you for your interest in `creportLib-component-explorer`, an open source project
administered by StrongLoop.

Contributing to `creportLib-component-explorer` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/creportLib-component-explorer)
