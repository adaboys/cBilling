...
[Table(DbConst.table_user_auth_token)]
[Index(nameof(user_id), nameof(token))]
public class UserAuthTokenModel : AutoGenerateUpdateTime {
	[Key]
	[Column("id")]
	...
	public UserAuthTokenModelConst.LoginType login_type { get; set; }

	/// [See Const] Indicates about client environment (android, ios, web,...) that be used for login.
	[Required]
	[Column("client_type", TypeName = "tinyint")]
	public UserAuthTokenModelConst.ClientType client_type { get; set; }
